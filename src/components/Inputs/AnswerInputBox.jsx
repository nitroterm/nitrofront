    ...
    <div className="w-72 relative">
      <div className="relative h-10 w-full min-w-[200px] flex">
        <textarea
          ...
          className='overflow-y-hidden resize-none h-28 w-[450px] pb-20 rounded-lg bg-[#080016] border border-white pl-3 pt-3 text-sm text-white outline-none font-bold text-[20px] mt-auto relative z-10'
        ></textarea>
        <svg 
          className='absolute top-0 right-0 z-20 mr-3 mt-3' 
          width="24px" 
          height="24px" 
          viewBox="0 0 24 24" 
          fill="none" 
