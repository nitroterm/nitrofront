    ...
    <div className="w-72 relative">
      <div className="relative h-10 w-full min-w-[200px]">
        <textarea
          ...
          className='overflow-y-hidden resize-none h-28 w-[450px] pb-20 rounded-lg bg-[#080016] border border-white pl-3 pt-3 text-sm text-white outline-none font-bold text-[20px] mt-auto'
        ></textarea>
