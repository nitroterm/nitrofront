        ...
        <div className='flex bg-[#080016] text-white pb-20 pl-10 border border-purple-900 rounded-lg'>
            ...
            <div className='flex flex-col items-center mr-16 gap-12 justify-center'>
                ...
                <div className='flex flex-col mt-12 gap-2'>
                    ...
                    <Link to="/login">
                        <button
                            className='text-white bg-[#290D59] hover:bg-[#411A83] w-96 p-2 transition duration-300 rounded-lg border border-purple-900 px-10 font-bold text-[15px]'>{text}</button>
                    </Link>
                </div>
            </div>
        </div>
